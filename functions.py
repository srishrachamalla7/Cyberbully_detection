...
def custom_input_prediction(text):
    ...
    vectoriser = pickle.load(open("C:/Users/Pc/Documents/GitHub/cyberbullying-tweet-recognition-app/tdf_vectorizer", "rb"))
    text = vectoriser.transform(text)
    model = pickle.load(open("C:/Users/Pc/Documents/GitHub/cyberbullying-tweet-recognition-app/model.bin", "rb"))
